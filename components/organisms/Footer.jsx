import { AtSign, Copyright, Github } from "lucide-react";
import Link from "next/link";

const Footer = () => {
  return (
    <div className="w-full bg-stone-900">
      <footer className="flex justify-between items-center max-w-300 h-32 m-auto text-white">
        <div className="flex items-center text-sm gap-1">
          <Copyright size={18} />
          Lee Hee Do. All rights are reserved.
        </div>
